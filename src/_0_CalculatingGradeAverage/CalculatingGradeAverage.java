package JavaReviewPractices._01_CalculatingGradeAverage;
...
public class CalculatingGradeAverage {
    ...
    public static void main(String[] args) {
        ...
        for (String lesson : lessons) {
            System.out.print("Enter your " + lesson + " exam grade : ");  // user input exam grade
        ...
        System.out.println(averageGrade >= 60 ? "Passed the Class" : "Failed in Class"); // without if/if-else
    }
}
